...
>
> **Built as a portfolio project** showcasing Flask backend architecture, OpenAI API integration, and real-world SaaS patterns.

---

## Demo Mode

**No API key required to explore.** When `OPENAI_API_KEY` is missing, the app automatically switches to Demo Mode — all AI responses (questions, evaluations, scores, feedback) are replaced with realistic simulated data so you can explore every feature without any setup.
...
| Feature | Details |
|---------|---------|
| **Resume-Tailored Questions** | 5 technical + 2 behavioural questions generated from your actual resume and the job description via GPT-4o-mini |
| **AI Answer Evaluation** | 0–10 scoring with strengths, gaps, and exactly 3 actionable improvement suggestions |
...
# Optional — leave blank to run in Demo Mode (no OpenAI account needed)
OPENAI_API_KEY=sk-...
```
